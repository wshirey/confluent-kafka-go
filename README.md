...
across all of our clients (also [confluent-kafka-python](https://github.com/wshirey/confluent-kafka-python)
and [confluent-kafka-dotnet](https://github.com/wshirey/confluent-kafka-dotnet)).
